package com.example.todu.important_task
...
import com.example.todu.utils.Common.Companion.messageNoBookmarkTask
...
fun ImportantTaskScreen(
    ...
    Scaffold(
        ...
        topBar = {
            HomeScreenAppBar(onClickNavigation = { openDrawer() }, R.string.bookmark)
        }
    ) { paddingValues ->
        ...
        TaskColumn(
            ...
            emptyScreen = { EmptyScreen(label = messageNoBookmarkTask) },
        )
    }
}